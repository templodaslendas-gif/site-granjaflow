...
export default function Home() {
  const schema = {
    ...
    "@graph": [
      ...
      { "@type": "SoftwareApplication", name: "GranjaFlow", applicationCategory: "BusinessApplication", operatingSystem: "Web", description: "Plataforma digital para gestão de granjas e produção animal.", audience: { "@type": "Audience", audienceType: "Produtores rurais" }, offers: { "@type": "Offer", price: "197.90", priceCurrency: "BRL", availability: "https://schema.org/OnlineOnly", url: "https://wa.me/5545999317831" } },
