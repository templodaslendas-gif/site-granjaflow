    ...
    <header className={`header ${scrolled ? "isScrolled" : ""}`}>
      <div className="navWrap">
        ...
        <div className="navActions">
          ...
          <a className="button buttonSmall" href={SALES_URL} target="_blank" rel="noopener noreferrer" data-track="header-sales">Quero contratar</a>
      ...
      {open && (
        <nav className="mobileNav" aria-label="Navegação móvel">
          ...
          <a className="button" href={SALES_URL} target="_blank" rel="noopener noreferrer" data-track="mobile-sales" onClick={() => setOpen(false)}>Quero contratar</a>
        </nav>
      )}
    </header>
  );
